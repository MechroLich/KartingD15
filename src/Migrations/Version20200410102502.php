 ...
 */
final class Version20200410102502 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE laptimes ADD CONSTRAINT FK_1F70399C3A974639 FOREIGN KEY (lap1_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
